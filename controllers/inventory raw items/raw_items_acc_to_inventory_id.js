...
const RawItemsAccToStatusAndInventoryId = (req,res) => {
    ...
    if(status && id ){
        ...
        WHERE inventory_store_raw_items.inventory_raw_item_status = '${status}' AND inventory_store_raw_items.raw_item_inventory_id='${id}' AND raw_item.raw_status ='ACTIVE' `;
