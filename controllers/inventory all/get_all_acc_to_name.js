...
const GetAllAccToName = (req,res) =>{
    ...
    if(name){
        ...
        SELECT 'inventory_store_products.product_id',inventory_store_products.inventory_product_id, inventory_store_products.product_id,product.product_name, 'inventory_store_products'
        FROM product
        ...
        SELECT 'inventory_store_raw_items._id',inventory_store_raw_items.raw_item_inventory_id, inventory_store_raw_items.raw_item_id,raw_item.raw_item_name, 'inventory_store_raw_items'
        FROM raw_item
